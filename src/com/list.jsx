    ...
    let htmlElement = list.map((element)=>{
        return (
          <div className='flex justify-between w-full' key={element.key}>
            ...
            <div>
                <button className='bg-transparent hover:bg-green-500 text-green-700 font-semibold hover:text-white py-2 px-4 border border-green-500 hover:border-transparent rounded text-xl' onClick={()=>{editItem(element.key)}}>Modify</button>
